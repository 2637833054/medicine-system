...
$sql = mysqli_query($conn,"update doctor set kangzuanbi = '{$ukangzuanbi}',kangzuankou = '{$ukangzuankou}',kangbaisanxibi = '{$ukangbaisanxibi}',kangbaisanxikou = '{$ukangbaisanxikou}',tangpizhibi = '{$utangpizhibi}',tangpizhikou = '{$utangpizhikou}',tangpizhixi = '{$utangpizhixi}',zhiqiguankou = '{$uzhiqiguankou}',zhiqiguanxi = '{$uzhiqiguanxi}',kangzuanbit = '{$ukangzuanbit}',kangzuankout = '{$ukangzuankout}',kangbaisanxibit = '{$ukangbaisanxibit}',kangbaisanxikout = '{$ukangbaisanxikout}',tangpizhibit = '{$utangpizhibit}',tangpizhikout = '{$utangpizhikout}',tangpizhixit = '{$utangpizhixit}',zhiqiguankout = '{$uzhiqiguankout}',zhiqiguanxit = '{$uzhiqiguanxit}' where id = '{$uid}'");
