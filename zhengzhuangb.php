...
$sql = mysqli_query($conn,"update doctor set sneezingb = '{$usneezing}',runnynoseb = '{$urunnynose}',nasalitchingb = '{$unasalitching}',stuffynoseb = '{$ustuffynose}',eyeitchingb = '{$ueyeitching}',envyb = '{$uenvy}',tearsb = '{$utears}',dayscoreb = '{$udayscore}',nightscoreb = '{$unightscore}' where id = '{$uid}'");
