...
$sql = mysqli_query($conn,"update doctorb set IgEb = '{$uIgE}',pimaob = '{$upimao}',jianguob = '{$ujianguo}',danbaib = '{$udanbai}',cengmanb = '{$ucengman}',zhenjunb = '{$uzhenjun}',shufenb = '{$ushufen}',caofenb = '{$ucaofen}' where id = '{$uid}'");
